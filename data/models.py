...
class KeyDetail(models.Model):
    mapillaryKey = models.CharField(max_length=150, null=True, blank=True)
    GoogleLoginClientID = models.CharField(max_length=200, null=True, blank=True)

    def __str__(self):
        return self.mapillaryKey + '' + self.GoogleLoginClientID
