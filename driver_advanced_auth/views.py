...
from driver_advanced_auth.models import UserDetail, CountryInfo, LanguageDetail
from driver_advanced_auth.serializers import RequestSerializer, CitySerializer, \
    OrganizationSerializer, ContentTypeSerializer, PermissionSerializers, AssociateGroupSerializer, GroupSerializer, \
    GroupSerializerNew, AdvAuthSerializer, UserSerializer, AdvUserSerializer, DetailsSerializer, \
    ApproveRejectRequestSerializer, RejectRequestSerializer, TokenSerializer, \
    GoogleUserSerializer, CountryInfoSerializer, LanguageDetailSerializer  # SendRoleRequestSerializer
...
from data.models import DriverRecordCopy, WeatherInfo, DriverRecord, DuplicateDistanceConfig, IrapDetail
...
class LanguageDetailsViewSet(viewsets.ModelViewSet):
    ...
    pagination_class = None
    filter_class = LanguageDetailFilter
    permission_classes = []
